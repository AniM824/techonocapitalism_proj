...
but for companies listed in talent_fac.txt.
Results written to talent_fac_sector_summaries.json.
Run talent_fac_sector_companies.py afterward to produce talent_fac_sector_map.json.
"""
import json
import os
import time
...
INPUT_FILE   = os.path.join(SCRIPT_DIR, "talent_fac.txt")
OUTPUT_FILE  = os.path.join(SCRIPT_DIR, "talent_fac_sector_summaries.json")
SERPAPI_KEYS = [
...
def main():
    ...
    print(f"Found {len(companies)} companies in talent_fac.txt.")
